...
//*
//* THE SPACE1 VALUE SHOULD WORK AS IS ARE BUT YOU
...
//SYSPRINT DD SYSOUT=*
//SYSMDECK DD UNIT=&UNIT1
//SYSUT1   DD UNIT=&UNIT1,&SPACE1
//SYSUT2   DD UNIT=&UNIT1,&SPACE1
//SYSUT3   DD UNIT=&UNIT1,&SPACE1
//SYSUT4   DD UNIT=&UNIT1,&SPACE1
//SYSUT5   DD UNIT=&UNIT1,&SPACE1
//SYSUT6   DD UNIT=&UNIT1,&SPACE1
//SYSUT7   DD UNIT=&UNIT1,&SPACE1
//SYSUT8   DD UNIT=&UNIT1,&SPACE1
//SYSUT9   DD UNIT=&UNIT1,&SPACE1
//SYSUT10  DD UNIT=&UNIT1,&SPACE1
//SYSUT11  DD UNIT=&UNIT1,&SPACE1
//SYSUT12  DD UNIT=&UNIT1,&SPACE1
//SYSUT13  DD UNIT=&UNIT1,&SPACE1
//SYSUT14  DD UNIT=&UNIT1,&SPACE1
//SYSUT15  DD UNIT=&UNIT1,&SPACE1
//         PEND