...
// MSGCLASS=H,MSGLEVEL=(1,1),REGION=200M
//*****************************************************************
//* LICENSED MATERIALS - PROPERTY OF IBM
//* "RESTRICTED MATERIALS OF IBM"
//* (C) COPYRIGHT IBM CORPORATION 2018, 2026. ALL RIGHTS RESERVED
//*
...
//* EASILY CUSTOMIZE THE JCL TO YOUR SYSTEM.  THE FOLLOWING
//* SYMBOLICS MUST BE CHANGED:
//*  - THE 'HLQ' VALUE, WHICH MUST CONTAIN THE HIGH LEVEL QUALIFIER
//*    UNDER WHICH THE SAMPLE DATASETS MAY RESIDE.
//*  - THE 'DBGADDR' VALUE, WHICH MUST CONTAIN THE IP ADDRESS OR
//*    HOSTNAME OF THE DEBUG CLIENT/ADAPTER.
//*
//* IT MIGHT ALSO BE NECESSARY TO UPDATE THE COBOL COMPILER AND/OR
//* DEBUGGER LIBRARY IF YOUR SYSTEM USES DIFFERENT VERSIONS OR NON-
//* DEFAULT LOCATIONS.
//*
...
//    SET DBGCOPTS='SOURCE,TEST'              *DEBUG COMPILE OPTS
//*
//*   FOR DEBUGGING WITH Z OPEN DEBUG FOR VS CODE, USE THIS LINE:
//    SET TESTOPT='/TEST(,,,RDS:*)'
//*
//*   FOR DEBUGGING WITH WAZI DEVELOPER FOR ECLIPSE, USE THIS LINE:
//*   SET TESTOPT='/TEST(,,,DBMDT:*)'
//*
//*   FOR DISABLE COLLECTING CODE COVERAGE, USE THIS LINE:
//*    SET CCOPT=''
//*
//*   TO ENABLE COLLECTING CODE COVERAGE, USE THIS LINE:
//    SET CCOPT='ENVAR("EQA_STARTUP_KEY=CC")'
//*
//***************************
//*                         *
//*  COMPILE SAM2          **
...
//***************************
//*
//CMPLSAM2 EXEC PGM=IGYCRCTL,PARM='LIST,MAP,NODYN,&DBGCOPTS'
//STEPLIB  DD DISP=SHR,DSN=&CMPLLIB
//SYSIN    DD DISP=SHR,DSN=&HLQ..SAMPLE.COBOL(SAM2)
//SYSLIB   DD DISP=SHR,DSN=&HLQ..SAMPLE.COPY
...
//***************************
//*
//CMPLSAM1 EXEC PGM=IGYCRCTL,PARM='LIST,MAP,&DBGCOPTS'
//STEPLIB  DD DISP=SHR,DSN=&CMPLLIB
...
//***************************
//*
//LINKSAM2 EXEC PGM=IEWL,REGION=1M
...
//***************************
//*
//LINKSAM1 EXEC PGM=IEWL,REGION=1M
//SYSLMOD  DD  DISP=SHR,DSN=&HLQ..SAMPLE.LOAD
//SYSPRINT DD  SYSOUT=*
//SYSUT1   DD  UNIT=&SPACE2
//SYSLIB   DD  DISP=SHR,DSN=&LINKLIB
...
//    DSORG=PS,RECFM=VB,LRECL=391,BLKSIZE=395
//*
//* OUTPUT CUSTRPT FILE
