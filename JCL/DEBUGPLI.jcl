//ZDPLIDBG JOB ,NOTIFY=&SYSUID,                                         JOB01614
...
//* COMPILE PSAM2
//*************************
//CMPPSAM2 EXEC PGM=IBMZPLI,PARM='LIST,MAP,RULES(LAXIF),&DBGCOPTS'
...
//* COMPILE PSAM1
//*************************
//CMPPSAM1 EXEC PGM=IBMZPLI,PARM='LIST,MAP,RULES(LAXIF),&DBGCOPTS'
//STEPLIB DD DISP=SHR,DSN=&CMPLLIB
//SYSPRINT DD SYSOUT=*
//SYSUT1   DD UNIT=&SPACE1
//SYSLIB   DD DISP=SHR,DSN=&HLQ..SAMPLE.PLINC
...
//* LINK PSAM1
//*************************
//LNKPSAM1 EXEC PGM=IEWL,REGION=3000K
